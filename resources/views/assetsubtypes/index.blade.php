...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        <div class="col-sm-8">
          <h3 class="box-title">List of Asset Sub Types</h3>
        </div>
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('assetsubtypes.create') }}">Add Asset Sub Type</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="assetsubtypes: activate to sort column ascending">Asset Sub Type Name</th>
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="categories: activate to sort column ascending">Asset category Code</th>
            ...
            <tfoot>
              <tr>
                <th width="20%" rowspan="1" colspan="1">Asset Sub Type Name</th>
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="categories: activate to sort column ascending">Asset Category Code</th>
